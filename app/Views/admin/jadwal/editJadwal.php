...
<main id="main" class="main">
    ...
    <form method="post" action="\updateJadwal\<?=$jadwal['id_jadwal'] ?>">
        <div class="form-row">
            ...
            <div class="form-group col-md-6 mb-3">
                ...
                <input type="time" class="form-control" id="waktu_keberangkatan" name="waktu_keberangkatan" value="<?php echo $jadwal['waktu_keberangkatan']; ?>"
            </div>
        </div>
