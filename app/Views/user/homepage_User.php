...
<html lang="en">
    ...
    <head>
    <link href="<?= base_url("assets/Arsha/assets/img/anjing/favicon.ico")?>" rel="icon">
    <!-- Bootstrap CSS -->
    ...
    <link rel="stylesheet" href="<?= base_url("https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css")?>" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    <link rel="stylesheet" href="<?= base_url("assets/Arsha/assets/css/pesanTiket.css")?>">
    <title>SIPETIK</title>
...
<div class="img"></div>
  ...
  <script src="<?= base_url("assets/Arsha/assets/js/TableFilter.min.js")?>" defer ></script>
  <script src="<?= base_url("assets/Arsha/assets/js/popup.js")?>"></script>
  <script src="<?= base_url("assets/Arsha/assets/js/popup_1.js")?>"></script>
</body>
